      ...
      >
        <div className="mb-4">
          <div className="relative">
            <input
              ...
              className="webkit-dark-styles transition-color peer w-full rounded-2xl border border-border-light bg-surface-primary px-3.5 pb-2.5 pt-3 text-text-primary duration-200 focus:border-[#800000] focus:outline-none"
              placeholder=" "
            />
            <label
              htmlFor="email"
              className="absolute start-3 top-1.5 z-10 origin-[0] -translate-y-4 scale-75 transform bg-surface-primary px-2 text-sm text-text-secondary-alt duration-200 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-1.5 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-[#800000] dark:peer-focus:text-[#B22222] rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4"
            >
              {useUsernameLogin
        ...
        {startupConfig.passwordResetEnabled && (
          <a
            ...
            className="inline-flex p-1 text-sm font-medium text-[#800000] underline decoration-transparent transition-all duration-200 hover:text-[#6E0000] hover:decoration-[#6E0000] focus:text-[#6E0000] focus:decoration-[#6E0000] dark:text-[#B22222] dark:hover:text-[#d45050] dark:hover:decoration-[#d45050] dark:focus:text-[#d45050] dark:focus:decoration-[#d45050]"
          >
